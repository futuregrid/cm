# -*- coding: utf-8 -*-
#
# Cloud Mesh documentation build configuration file, created by
...
latex_documents = [
  ('index', 'CloudMesh.tex', u'Cloud Mesh Documentation',
...
man_pages = [
    ('index', 'cloudmesh', u'Cloud Mesh Documentation',
